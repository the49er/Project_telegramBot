...
public class NotificationsTimeUkr extends BotCommand {

    public NotificationsTimeUkr() {
        super("notificationstimeukr", "Час cповіщення");
    }

    @Override
    public void execute(AbsSender absSender, User user, Chat chat, String[] arguments) {

        String text = "Додати час cповіщення \uD83D\uDD14";
