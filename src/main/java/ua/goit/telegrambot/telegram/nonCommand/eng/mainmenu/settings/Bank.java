...
public class Bank implements GeneralBotCommand {
    ...
    public SendMessage getMessage() {
        ...
        InlineKeyboardButton monoBank = InlineKeyboardButton.builder().text(this.checkout.equals("monobank") ? "✅ MonoBank" : "MonoBank").callbackData("setBankMonoBank").build();
        InlineKeyboardButton nBU = InlineKeyboardButton.builder().text(this.checkout.equals("nbu") ? "✅ NBU" : "NBU").callbackData("setBankNBU").build();
        InlineKeyboardButton privat = InlineKeyboardButton.builder().text(this.checkout.equals("privat") ? "✅ Privat" : "Privat").callbackData("setBankPrivat").build();
